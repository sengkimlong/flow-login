...
class XliffModel extends XliffModel_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$i18nLogger_reference = &$this->i18nLogger;
		$this->i18nLogger = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('');
		if ($this->i18nLogger === NULL) {
			$this->i18nLogger = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('b71ecee54936639f0b30261f9af1ff72', $i18nLogger_reference);
			if ($this->i18nLogger === NULL) {
				$this->i18nLogger = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('b71ecee54936639f0b30261f9af1ff72',  $i18nLogger_reference, '', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Log\LoggerFactory')->create('Flow_I18n', 'TYPO3\\Flow\\Log\\Logger', \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getSettingsByPath(explode('.', 'TYPO3.Flow.log.i18nLogger.backend')), \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getSettingsByPath(explode('.', 'TYPO3.Flow.log.i18nLogger.backendOptions'))); });
			}
		}
...
# PathAndFilename: /var/www/html/internship-project-3-team-2/flow_login/Packages/Framework/TYPO3.Flow/Classes/TYPO3/Flow/I18n/Xliff/XliffModel.php
#
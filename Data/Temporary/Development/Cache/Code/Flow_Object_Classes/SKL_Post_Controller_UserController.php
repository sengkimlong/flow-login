 ...
 */
class UserController_Original extends \TYPO3\Flow\Mvc\Controller\ActionController {
...
class UserController extends UserController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('SKL\Post\Controller\UserController' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('SKL\Post\Controller\UserController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('SKL\Post\Controller\UserController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('SKL\Post\Controller\UserController', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$this->userRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('SKL\Post\Domain\Repository\UserRepository');
		if ($this->userRepository === NULL) {
			$this->userRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('056f246181bacc801a6836b90675dbb0', $userRepository_reference);
			if ($this->userRepository === NULL) {
				$this->userRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('056f246181bacc801a6836b90675dbb0',  $userRepository_reference, 'SKL\Post\Domain\Repository\UserRepository', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('SKL\Post\Domain\Repository\UserRepository'); });
			}
		}
...
# PathAndFilename: /var/www/html/flow-login/Packages/Application/SKL.Post/Classes/SKL/Post/Controller/UserController.php
#
...
class HashService extends HashService_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		if ($this->cache === NULL) {
			$this->cache = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('b9dcc88a5cb96e77455a98b39cbe8f83', $cache_reference);
			if ($this->cache === NULL) {
				$this->cache = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('b9dcc88a5cb96e77455a98b39cbe8f83',  $cache_reference, '', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('TYPO3\Flow\Cache\CacheManager')->getCache('Flow_Security_Cryptography_HashService'); });
			}
		}
...
# PathAndFilename: /var/www/html/internship-project-3-team-2/flow_login/Packages/Framework/TYPO3.Flow/Classes/TYPO3/Flow/Security/Cryptography/HashService.php
#
...
class TemplateParser extends TemplateParser_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	 ...
	 */
	 protected function Flow_Aop_Proxy_buildMethodsAndAdvicesArray() {
		...
		$this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
			'emitInitializeNamespaces' => array(
	 ...
	 */
	 public function emitInitializeNamespaces(\TYPO3\Fluid\Core\Parser\TemplateParser $templateParser) {

				// FIXME this can be removed again once Doctrine is fixed (see fixMethodsAndAdvicesArrayForDoctrineProxiesCode())
			$this->Flow_Aop_Proxy_fixMethodsAndAdvicesArrayForDoctrineProxies();
		if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitInitializeNamespaces'])) {
		$result = parent::emitInitializeNamespaces($templateParser);

		} else {
			$this->Flow_Aop_Proxy_methodIsInAdviceMode['emitInitializeNamespaces'] = TRUE;
			try {
			
					$methodArguments = array();

				$methodArguments['templateParser'] = $templateParser;
			
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Fluid\Core\Parser\TemplateParser', 'emitInitializeNamespaces', $methodArguments);
				$result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitInitializeNamespaces']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitInitializeNamespaces']['TYPO3\Flow\Aop\Advice\AfterReturningAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Fluid\Core\Parser\TemplateParser', 'emitInitializeNamespaces', $methodArguments, NULL, $result);
				...
				unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitInitializeNamespaces']);
				throw $e;
			}
			unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitInitializeNamespaces']);
		}
...
# PathAndFilename: /var/www/html/internship-project-3-team-2/flow_login/Packages/Framework/TYPO3.Fluid/Classes/TYPO3/Fluid/Core/Parser/TemplateParser.php
#
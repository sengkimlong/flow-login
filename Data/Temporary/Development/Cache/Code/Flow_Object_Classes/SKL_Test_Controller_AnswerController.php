 ...
 * 
 */
class AnswerController extends AnswerController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('SKL\Test\Controller\AnswerController' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('SKL\Test\Controller\AnswerController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('SKL\Test\Controller\AnswerController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('SKL\Test\Controller\AnswerController', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$questionRepository_reference = &$this->questionRepository;
		$this->questionRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('SKL\Test\Domain\Repository\QuestionRepository');
		if ($this->questionRepository === NULL) {
			$this->questionRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('5f7019efa5103a5710a16c67ed185712', $questionRepository_reference);
			if ($this->questionRepository === NULL) {
				$this->questionRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('5f7019efa5103a5710a16c67ed185712',  $questionRepository_reference, 'SKL\Test\Domain\Repository\QuestionRepository', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('SKL\Test\Domain\Repository\QuestionRepository'); });
			}
		}
...
# PathAndFilename: /var/www/html/flow-login/Packages/Application/SKL.Test/Classes/SKL/Test/Controller/AnswerController.php
#
<?php class FluidCache_SKL_Post_Post_action_edit_7caf11efcd571c940436ecfd299720c7c6ff6c35 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments25 = array();
$arguments25['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.name', $renderingContext);
...
$arguments31['object'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post', $renderingContext);
$arguments31['objectName'] = 'post';

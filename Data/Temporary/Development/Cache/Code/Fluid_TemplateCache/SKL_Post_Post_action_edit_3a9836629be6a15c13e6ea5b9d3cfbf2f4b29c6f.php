<?php class FluidCache_SKL_Post_Post_action_edit_3a9836629be6a15c13e6ea5b9d3cfbf2f4b29c6f extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output22 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'cat.title', $renderingContext);
...
$output64 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'cat.title', $renderingContext);

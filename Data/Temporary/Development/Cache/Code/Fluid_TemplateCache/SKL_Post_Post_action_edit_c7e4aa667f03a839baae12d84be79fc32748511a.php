<?php class FluidCache_SKL_Post_Post_action_edit_c7e4aa667f03a839baae12d84be79fc32748511a extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output22 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.', $renderingContext);
...
$output64 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.', $renderingContext);

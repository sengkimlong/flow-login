<?php class FluidCache_SKL_Post_Post_action_edit_83f891f284059eed8b680db23eefbba0b7acf8ff extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output15 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'cat.identity', $renderingContext);

$output15 .= ' == {post.categories[key.cycle].identity}';
...
$output86 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'cat.identity', $renderingContext);

$output86 .= ' == {post.categories[key.cycle].identity}';

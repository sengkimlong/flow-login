<?php class FluidCache_SKL_Post_Post_action_edit_aa9ff1b37f1bb69ff1f914d622a1961abd3800b7 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
return \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.number.title', $renderingContext);
};
...
$output13 .= $viewHelper25->initializeArgumentsAndRender();
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments64 = array();
$arguments64['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'key', $renderingContext);

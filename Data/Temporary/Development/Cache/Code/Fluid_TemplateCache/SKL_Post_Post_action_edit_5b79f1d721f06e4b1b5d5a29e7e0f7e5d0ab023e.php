<?php class FluidCache_SKL_Post_Post_action_edit_5b79f1d721f06e4b1b5d5a29e7e0f7e5d0ab023e extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output25 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'number', $renderingContext);
return $output25;
};
...
$output70 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'number', $renderingContext);
return $output70;
};

<?php class FluidCache_SKL_Post_Post_action_edit_8d2966a4687465785733c9bb511be040979d1533 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments17['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'cat.identity', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Form\CheckboxViewHelper
$arguments55 = array();
$arguments55['property'] = 'categories';
$arguments55['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'cat.identity', $renderingContext);
// Rendering Boolean node
$arguments55['multiple'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\BooleanNode::convertToBoolean('true');
$arguments55['additionalAttributes'] = NULL;
$arguments55['data'] = NULL;
$arguments55['checked'] = NULL;
...
$viewHelper57 = $self->getViewHelper('$viewHelper57', $renderingContext, 'TYPO3\Fluid\ViewHelpers\Form\CheckboxViewHelper');

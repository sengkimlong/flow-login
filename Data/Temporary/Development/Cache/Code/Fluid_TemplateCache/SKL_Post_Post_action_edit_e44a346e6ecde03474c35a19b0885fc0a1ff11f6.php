<?php class FluidCache_SKL_Post_Post_action_edit_e44a346e6ecde03474c35a19b0885fc0a1ff11f6 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output22 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.0', $renderingContext);
...
$output64 .= \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.0', $renderingContext);

<?php class FluidCache_SKL_Post_Post_action_edit_542370e838fd79ea306d04b9bad2fae28d449812 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
// Rendering Array
$array24 = array();
$array24['x'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.number.title', $renderingContext);
$arguments23['map'] = $array24;
$renderChildrenClosure25 = function() use ($renderingContext, $self) {
return \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'x', $renderingContext);
};
...
// Rendering Array
$array70 = array();
$array70['x'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'post.categories.number.title', $renderingContext);
